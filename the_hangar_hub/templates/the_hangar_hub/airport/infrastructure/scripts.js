...
function invite_manager() {
    ...
    $.ajax({
        type:   "POST",
        url:    "{%url 'airport:add_manager' airport.identifier%}",
        data:   {
            csrfmiddlewaretoken: '{{ csrf_token }}',
            airport_id: airport_id,
            invitee: invitee
...
function change_am_status(select_menu_el){
    ...
    $.ajax({
        type:   "POST",
        url:    "{%url 'airport:update_manager' airport.identifier%}",
        data:   {
            csrfmiddlewaretoken: '{{ csrf_token }}',
...
function delete_hangar(el){
    ...
    $.ajax({
        type:   "POST",
        url:    "{%url 'infrastructure:delete_hangar' airport.identifier%}",
        data:   {
            csrfmiddlewaretoken: '{{ csrf_token }}',
            hangar_id: hangar_id,
        },
