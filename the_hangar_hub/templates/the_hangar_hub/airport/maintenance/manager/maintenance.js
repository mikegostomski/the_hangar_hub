...
function update_priority(input_el){
    ...
    $.ajax({
        type:   "POST",
        url:    "{%url 'manage:update_mx_priority' request.airport.identifier mx_request.id%}",
        data:   {
...
function update_status(input_el){
    ...
    $.ajax({
        type:   "POST",
        url:    "{%url 'manage:update_mx_status' request.airport.identifier mx_request.id%}",
        data:   {
            csrfmiddlewaretoken: '{{ csrf_token }}',
...
function _update_visibility(comment_id, btn_el, visibility_code){
    ...
    $.ajax({
        type:   "POST",
        url:    "{%url 'manage:mx_comment_visibility' request.airport.identifier%}",
        data:   {
            csrfmiddlewaretoken: '{{ csrf_token }}',
