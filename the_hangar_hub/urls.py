...
mx_paths = [
    # MAINTENANCE
    path(f'{airport}/maintenance/request/comment/{request}', mx_shared_v.post_comment,  name='post_mx_comment'),

    # MAINTENANCE
    path(f'{airport}/maintenance/request/comment/{request}', mx_shared_v.post_comment, name='post_mx_comment'),

    path(f'maintenance', mx_tenant_v.tenant_dashboard, name='mx_dashboard'),
    path(f'{airport}/maintenance/request/{hangar}', mx_tenant_v.tenant_request, name='mx_request_form'),
    path(f'{airport}/maintenance/request/{hangar}/post', mx_tenant_v.tenant_request_submit, name='submit_mx_request'),
    path(f'{airport}/maintenance/request/view/{request}', mx_tenant_v.tenant_request_view, name='view_mx_request'),

    path(f'{airport}/maintenance', mx_mgmt_v.manager_dashboard,  name='mx_dashboard'),
    path(f'{airport}/maintenance/request/view/{request}', mx_mgmt_v.manager_request_view,  name='view_mx_request'),
    path(f'{airport}/maintenance/request/priority/{request}', mx_mgmt_v.update_priority,  name='update_mx_priority'),
    path(f'{airport}/maintenance/request/status/{request}', mx_mgmt_v.update_status,  name='update_mx_status'),
    path(f'{airport}/maintenance/request/comment/visibility', mx_mgmt_v.update_visibility,  name='mx_comment_visibility'),
]
