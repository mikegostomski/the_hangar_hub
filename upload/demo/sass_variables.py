...
# Logo will be automatically filtered to match the primary_fg_color (if other than the default; white)
...
BOOTSTRAP_PRIMARY = None                # base-green
BOOTSTRAP_PRIMARY_COMPLIMENT = None     # white
BOOTSTRAP_DEFAULT = None                # base-gray
BOOTSTRAP_DEFAULT_COMPLIMENT = None     # white

# Standard danger, warning, etc colors
BOOTSTRAP_DANGER = None                 # base-red
BOOTSTRAP_DANGER_COMPLIMENT = None      # white
BOOTSTRAP_WARNING = None                # base-orange (yellowish)
BOOTSTRAP_WARNING_COMPLIMENT = None     # base-brown
BOOTSTRAP_INFO = None                   # base-blue
BOOTSTRAP_INFO_COMPLIMENT = None        # white
BOOTSTRAP_SUCCESS = None                # base-accent-green
